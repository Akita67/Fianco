...
public class BVBSelectionScreen implements Screen {
    ...
    public BVBSelectionScreen(Main game, boolean ai, boolean ai2) {
        ...
        bots1.setItems("Random bot", "Alpha Beta","MCTS", "OneLookAhead bot", "Depth Limiting Tree bot", "Predict bot (supervised learning)", "BOB (Double DQN)");
        bots1.setPosition(400, 350);
        bots1.setSize(200, 50);

        bots2 = new SelectBox<String>(menuSkin);
        bots2.setItems("Random bot", "Alpha Beta","MCTS", "OneLookAhead bot", "Depth Limiting Tree bot", "Predict bot (supervised learning)", "BOB (Double DQN)");
